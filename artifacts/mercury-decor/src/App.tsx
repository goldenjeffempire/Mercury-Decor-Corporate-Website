...
const projectVideos = [
  ...
  { src: `${import.meta.env.BASE_URL}project-videos/video-07.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-07.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-07-poster.jpg`, title: 'Linear ceiling details', description: 'A close look at a crisp ceiling installation with recessed borders and architectural lighting.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-08.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-08.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-08-poster.jpg`, title: 'Illuminated ceiling collection', description: 'A longer project view featuring layered ceiling forms, warm coves and linear LED work.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-09.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-09.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-09-poster.jpg`, title: 'Contemporary interior lighting', description: 'Finished interior spaces where ceiling design, lighting and joinery work together.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-10.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-10.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-10-poster.jpg`, title: 'Ceiling installation study', description: 'A project sequence showing the scale and geometry of a modern decorative ceiling.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-11.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-11.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-11-poster.jpg`, title: 'Finished room lighting', description: 'A room-by-room view of finished ceiling lighting and coordinated interior details.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-12.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-12.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-12-poster.jpg`, title: 'Decorative ceiling walkthrough', description: 'A walkthrough of layered forms, recessed lighting and finishing precision.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-13.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-13.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-13-poster.jpg`, title: 'Architectural light lines', description: 'Linear LEDs and perimeter lighting shown across a completed ceiling installation.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-14.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-14.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-14-poster.jpg`, title: 'Interior finishing in motion', description: 'A longer showroom view of modern ceilings, lighting and interior finishing work.' },
  { src: `${import.meta.env.BASE_URL}project-videos/video-15.mp4`, webm: `${import.meta.env.BASE_URL}project-videos/video-15.webm`, poster: `${import.meta.env.BASE_URL}project-videos/video-15-poster.jpg`, title: 'Ceiling design close-up', description: 'A compact detail view of layered ceiling edges, downlights and illuminated forms.' },
];
